...
execute as @s[scores={gz-a4-partytime=250}] at @s run function gamerz_riot:mob/08-p01-vex
execute as @s[scores={gz-a4-partytime=225}] at @s run function gamerz_riot:effects/party-mob-destruction
execute as @s[scores={gz-a4-partytime=225}] at @s run function gamerz_riot:mob/08-p01-vex
execute as @s[scores={gz-a4-partytime=200}] at @s run function gamerz_riot:effects/party-mob-destruction
execute as @s[scores={gz-a4-partytime=200}] at @s run function gamerz_riot:mob/08-p02-spider
execute as @s[scores={gz-a4-partytime=175}] at @s run function gamerz_riot:effects/party-mob-destruction
execute as @s[scores={gz-a4-partytime=175}] at @s run function gamerz_riot:mob/08-p02-spider
execute as @s[scores={gz-a4-partytime=150}] at @s run function gamerz_riot:effects/party-mob-destruction
execute as @s[scores={gz-a4-partytime=150}] at @s run function gamerz_riot:mob/08-p03-witch
execute as @s[scores={gz-a4-partytime=125}] at @s run function gamerz_riot:effects/party-mob-destruction
execute as @s[scores={gz-a4-partytime=125}] at @s run function gamerz_riot:mob/08-p01-vex